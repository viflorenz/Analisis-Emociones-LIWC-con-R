...
library(rtweet)
#guardar llaves api
api_key <- "7dWZvZZmJMDCFxx74CDOMEhoL"
api_secret_key <- "r0oVd95CmxqBwwAGuF25yqjfxxWmSfIBCbcE83HimNBX7L6Ijh"
access_token <- "99630936-xpszJWZyitu4XIqfZl5tPfhwq1gzC9dIwU3bO79B1"
access_token_secret <- "R0K0Z8JZo9pY8jKfS0cQEdf45IEF8XEmMopXI6tqXAN6m"
